...
const logCmds = DEBUG_COMMANDS
const logDb = DEBUG_DB
const logRedux = DEBUG_ACTION
const logTabkey = DEBUG_TAB_KEY
const logWS = DEBUG_WS
const logNetwork = DEBUG_NETWORK
const logAnalytics = DEBUG_ANALYTICS
const logApdu = DEBUG_DEVICE
